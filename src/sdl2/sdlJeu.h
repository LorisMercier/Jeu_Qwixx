...
private :
     ...
     * 
     * @param posFiche SDL_Rect : position et dimension de la fiche principale
     * @param boutonFin SDL_Rect : position et dimension du bouton fin
     * @param numJoueur int : Indice du joueur en cours
     ...
     * 
     * @param boutonRec SDL_Rect : position et dimension du bouton Recommencer
     * 
     */
    void sdlAffFin(const SDL_Rect &boutonRec);
